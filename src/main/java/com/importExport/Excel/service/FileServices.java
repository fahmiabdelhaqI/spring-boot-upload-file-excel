...
import com.importExport.Excel.repository.CustomerRepository;
import com.importExport.Excel.utils.ExcelUtils;
...
public class FileServices {
    ...
    public ByteArrayInputStream loadFile() {
    	...
    	try {
    		ByteArrayInputStream in = ExcelUtils.customerToExcel(customers);
    		return in;
		} catch (IOException e) {}
